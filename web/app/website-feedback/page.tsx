...
export default function WebsiteFeedbackPage() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Explorush - Website Feedback",
      text: "Help shape the journey! Provide your feedback for Explorush.",
      ...
      <main className="bg-cream text-charcoal min-h-screen font-sans">
        ...
        <section className="max-w-4xl mx-auto px-6 pt-14 pb-8 text-center space-y-4">
          ...
          <p className="text-charcoal/70 text-sm md:text-base leading-relaxed max-w-lg mx-auto font-sans">
            We'd love to hear your thoughts, suggestions, or reports about your experience on Explorush. Help us shape the future of our journeys!
          </p>
          ...
          <div className="flex justify-center pt-2">
            <button
              ...
              aria-label="Share this feedback form link"
            >
