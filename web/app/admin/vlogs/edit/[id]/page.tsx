  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-4">
        ...
        <p className="text-charcoal/50 font-semibold">Loading vlog details...</p>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-charcoal/70 mt-1 font-medium">Make changes to your published video link.</p>
        </div>
      </div>
