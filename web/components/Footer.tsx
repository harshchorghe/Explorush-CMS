  ...
  return (
    <footer className="bg-primary text-cream/90 pt-6 pb-4 border-t border-secondary/30 mt-auto">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-y-6 md:gap-x-8">
        ...
        {/* Col 4: WhatsApp Channel */}
        <div className="space-y-2">
          <h4 className="text-xs font-serif font-bold text-accent tracking-wider uppercase">Latest Updates</h4>
          <p className="text-[11px] text-cream/70 font-sans leading-relaxed">
            Join our WhatsApp channel to get the latest updates on upcoming group trips, workshops, and exclusive travel stories.
          </p>
          <div className="pt-1">
            <a
              href="https://whatsapp.com/channel/0029VbBoiXf4dTnHbuKzuH0a"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-2 bg-[#25D366] hover:bg-[#22c35e] text-white font-sans font-bold text-xs uppercase tracking-wider rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg"
            >
